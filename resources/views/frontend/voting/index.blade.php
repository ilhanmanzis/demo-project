...
<body>
    <div id="app">
        ...
        <div class="container ">
            <div class="row pt-5 ms-4 me-4 ms-lg-0 me-lg-0 ms-md-0 me-md-0 ">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <div class="card-content">
                                        <img class="img-fluid w-100" src="{{ $kandidat->photo_path }}"
                                            alt="Card image cap">
                                        <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <button class="btn btn-secondary btn-block mb-3" data-bs-toggle="modal"
                                            data-bs-target="#default" data-visi="{{ $kandidat->visi }}"
                                            data-misi="{{ $kandidat->misi }}">Lihat Visi & Misi</button>
                                        <button type="button"
                                            onclick="konfirmasi(`{{ route('voting.store', $kandidat->id) }}`)"
    ...
    <div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <script>
                    // Menangkap event klik pada semua tombol yang memiliki data untuk visi dan misi
                    document.querySelectorAll('.btn[data-bs-toggle="modal"]').forEach(button => {
                        button.addEventListener('click', function() {
                            // Mengambil data dari atribut data-visi dan data-misi
                            const visi = this.getAttribute('data-visi');
                            const misi = this.getAttribute('data-misi');

                            // Mengisi konten modal
                            document.getElementById('visi').innerHTML = visi.replace(/\#/g, '.<br>');
                            document.getElementById('misi').innerHTML = misi.replace(/\#/g, '.<br>');
                        });
                    });
                </script>
